...
|------|------|----------|------|-----------|------|
| 高级散户 | 2,400 (12子种群×200) | 2万 | 10.0x | 5档 | 挂单/撤单/吃单/不动 |
| 做市商 | 400 (4子种群×100) | 10M | 10.0x | 5档 | 双边挂单（每边1-10单），报价中心使用 AS 模型的 reservation price 而非 mid_price |
