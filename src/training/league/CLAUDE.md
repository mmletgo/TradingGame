...
| 散户挑战赛 | 当代散户 | 历史 MM（1 entry 全量 1,200） | 6 | 测试当代散户对历史 MM 的适应力 |
| MM 挑战赛 | 历史散户（1 entry 全量 4800） | 当代 MM | 6 | 测试当代 MM 对历史散户的适应力 |
...
| 类型 | 当前代 | 历史代（6代×全量） | 总计 |
|------|--------|-------------------|------|
| 高级散户 | 4,800 | 28,800（6×4800） | 33,600 |
| 做市商 | 1,200 | 7,200（6×1200） | 8,400 |
| 噪声交易者 | 600（增强） | - | 600 |
...
| 竞技场类型 | 散户 | 做市商 | 噪声交易者 |
|-----------|------|--------|-----------|
| 纯竞技场 | 当代 4,800 | 当代 1,200 | 600 |
| 散户挑战赛 | 当代 4,800 | 历史 1 entry（1,200），排除当代 MM | 600 |
| MM 挑战赛 | 历史 1 entry（4,800），排除当代散户 | 当代 1,200 | 600 |
...
| `hybrid_noise_trader_count` | 600 | 混合竞技场噪声交易者数 |
...
```
┌───────────────────────────┬──────────┬──────────┬───┬──────────┐
│ 当前代 (index 0..4799)    │ Entry_A  │ Entry_B  │...│ Entry_F  │
│   10子种群 × 480          │ 全量4800 │ 全量4800 │   │ 全量4800 │
└───────────────────────────┴──────────┴──────────┴───┴──────────┘
总共 4800 + 6×4800 = 33600 个网络
