...
class TrainingUIApp:
    ...
    def __init__(self, trainer: "Trainer", episodes: int) -> None:
        """初始化训练模式UI应用
    ...
    def _on_start(self) -> None:
        ...
        启动训练模式，在后台线程中运行训练循环。
        """
        self.controller.start_training(self.episodes)
    ...
    def _update_ui(self) -> None:
        ...
        try:
            ...
            if self.chart_panel:
                ...
                self.chart_panel.update_noise_trader_violin(data.noise_trader_data)
